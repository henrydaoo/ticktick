const Background = () => {
  return (
    <div className="absolute inset-0 text-white bg-[#084FFF] overflow-hidden pointer-events-none animate-fade-in">
      <div className="bg-[#084FFF] w-full h-full flex items-center justify-center">
        <div
          className="w-[150%] aspect-square rounded-full bg-[#0648DB] flex items-center justify-center -mt-[15%] animate-scale-in"
